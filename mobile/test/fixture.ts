 ...
 * `container/backend/src/chave.ts` would reject it as malformed.
 *
 ...
 * their CPF. See container/backend/test/fixture.ts, which keeps real captures
 * out of git for the same reason.
 */
